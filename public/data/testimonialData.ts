...
[
    ...
    {
      "review": "Our consultancy teams save hours every week. The consolidation automation auto-creates all documents, names them perfectly, and stores them in the right Drive folders. Zero manual errors, 100% organized.",
      "name": "Ryan Patel",
      "position": "Operations Lead, StartEdge Consultancy",
      "image": "/images/avatar.jpg"
    },
    {
      "review": "The local services WhatsApp connector changed how we connect customers with plumbers, electricians, and AC repair pros. It’s instant, reliable, and earns recurring income from service-provider subscriptions.",
      "name": "Miller Rek",
      "position": "Founder, Fixtel Services",
      "image": "/images/avatar.jpg"
    }
  ]
